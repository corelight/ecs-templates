...
def var_replace_prompt(use_templates=False, use_pipelines=False, Final_Pipelines_Dir=None, Final_Templates_Dir=None):
    ...
    VAR_CL_DS_SUFFIX_PROTOCOL_LOG_dict = {
        ...
        "VAR_CL_DS_SUFFIX_PROTOCOL_LOG_SSH": "ssh",
    ...
    VAR_CL_DS_INDEX_PATTERN_PROTOCOL_LOG_dict = {
        ...
        "VAR_CL_DS_INDEX_PATTERN_PROTOCOL_LOG_SSH": f'{VAR_CL_DS_TYPE_PROTOCOL_LOG}-{VAR_CL_DS_PREFIX_PROTOCOL_LOG}.{VAR_CL_DS_SUFFIX_PROTOCOL_LOG_dict.get("VAR_CL_DS_SUFFIX_PROTOCOL_LOG_SSH")}-*',
